...
<html>
    ...
    <body id="ask">
        ...
        <a href="index.php">
            <div id="log">
                <div id="i">U</div><div id="cir">U</div><div id="ntro">DAA</div>
            </div>
        </a>
        <ul id="nav-bar">
            ...
            <div id="sf">
                <center>
                    <div class="heading ask">
                        <h1 class="logo"><div id="i">U</div><div id="cir">U</div><div id="ntro">daa</div></h1>
                        <p id="tag-line">Solve Your Questions</p>
                    </div>
